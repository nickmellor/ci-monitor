...
class CUSBaccess {
	...
	public:
		...
		virtual int			OpenCleware(const char *path = NULL) ;			// returns number of found Cleware devices
		...
		virtual int			SelectADCChannel(int deviceNo, int channel);
		virtual double			 GetADCValue(int deviceNo, int scale);
	} ;
%}
